...
Every TIP4.1 compliant NFT contract must implement the `ITIP41NFT` interface and [TIP-6.1](./../TIP-6/1.md) interfaces
...
interface ITIP41NFT {
    ...
    /// @param owner Address of NFT owner
    /// @param manager Address of NFT manager
    /// @param collection Address of collection smartcontract, that mint the NFT
    ...
    /// @return collection Address of collection smartcontract
...
Change NFT owner. Emit ownerChanged and managerChanged events when NFT owner changed. The NFT send callbacks if `callbacks` not empty.
...
Change NFT manager. Emit managerChanged event. The NFT send callbacks if `callbacks` not empty.
