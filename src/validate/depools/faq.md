...
Currently, this can be done through [TONOS-CLI](../../develop/sdk-tools/tonos-cli.md). It should be configured to be used with DePool. A participant needs to know the DePool address and have a suitable contract holding the funds they want to invest (e.g. a multisig wallet).
