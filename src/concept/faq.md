...
- [Smart contracts](../learn/01-introduction.md) can perform operations on different nodes, which allows the blockchain to scale ([sharding](../arch/10-basics.md/#blockchain-structure)) and increases the speed of smart contract execution to an absolute record.
...
- [Decentralization section](decentralization.md)
- [Smart Contracts section](../learn/01-introduction.md)
  - [Introduction](../learn/01-introduction.md)
...
Since Everscale is quite a young network, there are a lot of opportunities for developers here: [hachatons and grants](../develop/hackathons-grants.md), [Smart Contracts](../learn/01-introduction.md) developing, [DAO](https://everdao.net), etc.
