...
in DeBot. All accepted interfaces are published in [DeBot Interface Specifications Consortium](debot.md#debot-is-consortium).
...
the [DeBot Interface Specifications Consortium](debot.md#debot-is-consortium).
...
In terms of DeBot, all these features are implemented without [DInterfaces](debot.md#debot-interfaces) but in a native way, like two smart contracts communicating with each other — by sending messages directly to target address.
