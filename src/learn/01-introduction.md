...
![](https://www.plantuml.com/plantuml/proxy?cache=no&src=https://raw.githubusercontent.com/everscale-org/docs/learn/src/learn/message-1.puml)

## Gas usage

We are not going to cover the exact formulas you can find more information in the [Fee calculation](../arch/fee-calculation.md) section. We will just cover what you need to know and what you are paying for.
