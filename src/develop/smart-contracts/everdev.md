---
sidebar_position: 0
title: Everdev CLI Quick Start
---

# Everdev CLI Quick Start
...
- [Everdev CLI Quick Start](#everdev-cli-quick-start)
  ...
  - [Table of Contents](#table-of-contents)
    ...
    - [Switch to Development Network](#switch-to-development-network)
    - [Set a giver contract on your network](#set-a-giver-contract-on-your-network)
...
If you experience any problems with installation, check out our [troubleshooting section](https://docs.everos.dev/everdev/troubleshooting).
...
[https://devnet.evercloud.dev/projectID/graphql](https://devnet.evercloud.dev/projectID/graphql)
...
**Now you can do all the steps of this guide on devnet and see your transactions on your GraphQL playground at** [**https://devnet.evercloud.dev/projectID/graphql**](https://devnet.evercloud.dev/projectID/graphql) **and**  [**ever.live**](https://net.ever.live/landing)**!**
...
2. If you want to integrate your application with Everscale - dive into our [SDK Quick Start](https://docs.everos.dev/ever-sdk/quick_start)!
