...
The mechanism describing how this works in detail is quite difficult and can be read in the [following article](https://mnill.github.io/everscale-for-solidity-dev/distributed_programming).
