...
The mechanism describing how this works in detail is quite difficult and can be read in the [following article](../../concept/smart-contracts/10-distributed-programming.md).
