...
> **Note**: Not all transactions that are successful are valid transfers and not all transactions that are aborted actually failed. Read [here](../../arch/transactions.md#how-to-determine-a-successful-transaction) how to understand which transfers are successful transfers and which are not.
