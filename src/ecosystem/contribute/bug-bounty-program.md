...
Here, we provide a brief example of how the Vulnerability Report should look like for some fictional vulnerability in the [SafeMultisigWallet](../../develop/multisignature-wallet.md).
